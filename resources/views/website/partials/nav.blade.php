<nav x-init="navScrolled = false" id="nav" x-bind:style="!navScrolled && { 'box-shadow': '0px 0px 10px 0px #ddd' }" class="bg-white z-40 fixed w-full top-0"> <!-- :class="{'bg-red-200' : !navScrolled }" -->

...
@section('content')
<section>
			<div class="min-h-screen w-full flex items-center justify-center" style="background: url('../img/impact_uk_banner_1.png') no-repeat; background-size: cover; background-position: center">
				<div class="bg-white sm:max-w-3xl w-xl px-8 sm:px-16 py-12 sm:py-16 mt-36 bg-opacity-90 mx-auto text-center z-10">
					<div>
						...
						<p class="text-sm text-gray-700 font-semibold pt-4">March 2022</p>
					</div>
				</div>
			</div>
		...
		<section class="max-w-5xl mx-auto px-8 pb-36 pt-16">
			<div>
				...
				<img src="../img/impact_uk_logo_1.png" class="w-full sm:w-3/4 mt-8 mx-auto">
				...
				<p class="mt-8">This project focused on creating the visual identify for the company Impact UK. This required logo design, typography and color palette definition.</p>
				...
				<img src="../img/impact_uk_logo_2.png" class="w-full sm:w-3/4 mt-8 mx-auto">

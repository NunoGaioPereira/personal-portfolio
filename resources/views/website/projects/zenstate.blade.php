...
<section class="" id="about">
    <div class="min-h-screen w-full flex items-center justify-center" style="background: url('../img/zenstate1.png') no-repeat; background-size: cover; background-position: center">
        <div class="bg-white sm:max-w-3xl w-xl px-8 sm:px-16 py-12 sm:py-16 mt-36 bg-opacity-90 mx-auto text-center z-10">
            <div>
                ...
                <h2 class="font-bold text-xl sm:text-4xl pb-4">Zenstate</h2>
                <span class="bg-gray-300 h-8 sm:h-14 py-4 block mx-auto" style="width: 2px;"></span>
                <p class="text-sm text-gray-700 font-semibold pt-4">March 2020</p>
            </div>
        </div>
    </div>
...
<section class="max-w-5xl mx-auto px-8 pb-36 pt-16" id="about">
    <div>
        <h2 class="font-semibold text-3xl">Zenstate</h2>
        <p class="text-gray-400 font-medium text-xl">Web App Design and Development</p>
        <p class="mt-4">Zenstate is a meditation timer web application. With a minimalist design, Zenstate uses audio and video to bring peacefulness and inner conscisousness to your life.</p>
        <p class="mt-4">Zenstate has been developed with HTML, CSS and Javascript.</p>
        ...
        <img src="../img/zenstate1.png" class="w-full sm:w-3/4 mt-8 mx-auto">
